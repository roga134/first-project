...
questions_cat = ['alive' , 'cute' ,'animals' , 'animal' , 'feet' , '4 feet' , 'four feet' , 'wool' , 'short wool' , 'made sound' , 'make sound' , '3 letters' , 'three letters' , 'run' , 'walk' , '3 characters' , 'three characters' , 'meat eater' , 'mammals' , 'mammal' ,  'small body' , 'pet' , 'pets' , 'domestic' , 'domestics' , 'pet animals' , '4feet']
questions_book = ['' ]
questions_dress = [ '']
# shervin 
<<<<<<< HEAD
...
questions_giraffe = [ 'alive' , 'animals' , 'animal' , 'feet' , '4 feet' , 'four feet' , 'wool' , 'short wool' , 'made sound' , 'make sound' , '3 letters' , 'three letters' , 'run' , 'walk' , '3 characters' , 'three characters' , 'meat eater' , 'mammals' , 'mammal' ,  'small body' , 'pet' , 'pets' , 'domestic' , 'domestics' , 'pet animals' , '4feet' , 'long neck' , 'ear' , '2ear' ]
...
=======
questions_guitar = ['things' , 'music' , 'sing with it ', 'song' , 'sing' , 'tar' , 'line' ,'the wire' , 'nylon' , 'head' , 'tuning keys' , 'nut' , 'frets' , 'nech' , 'fret board' , ' upper bout' , 'rossette' , 'sound hole' , 'bridge saddle' , 'body' , 'bridge' , 'lower bout' , 'sound bord' , '6sim' , 'headstock' , 'nut' , ' machine heads ' , 'frets ', 'truss rod' , 'lnlays' , 'neck and fretboard ' , 'neck joint' , ' body' , ' pickups ' , 'electronics' ,'bridge' , 'stop tailpiece' , 'pickguard' , 'toggle' , 'switch']
questions_giraffe = [ 'alive' ]
questions_keyboard = ['things' , 'things of computer', 'connect to computer' , 'mouse' , 'button' ,  'letters' , 'number' , 'left' , 'right' , 'space' , 'office' , 'gaming' , 'usb' , 'home' , 'end' , 'lnsert' , 'delete' , 'page up' , 'page down' ,'control' , 'alt' , 'foldable keyboard' , 'shift' , 'enter' , 'ctrl' , 'backspace' ,'voice' , 'silent' , 'shift' , ' alt' , 'fn' , 'alt' ,  'lighting' , 'the darkness' , 'tab' , 'home' , ' pgup' ,' pgdn' , 'esc' , 'top' , 'down' , 'positive' , 'negative' ,'multiplication' , 'division' , 'big' , ' little' , 'hashtak' , ' dot' , 'beauiful' , 'question mark ' , 'exclamation mark']
>>>>>>> 79190a65fe32922255fd57a939d712209e7c51d9
=======
questions_guitar = ['things' , 'music' , 'sing with it ', 'song' , 'sing' , 'tar' , 'line' ,'the wire' , 'nylon' , 'head' , 'tuning keys' , 'nut' , 'frets' , 'nech' , 'fret board' , ' upper bout' , 'rossette' , 'sound hole' , 'bridge saddle' , 'body' , 'bridge' , 'lower bout' , 'sound bord' , '6sim' , 'headstock' , 'nut' , ' machine heads ' , 'frets ', 'truss rod' , 'lnlays' , 'neck and fretboard ' , 'neck joint' , ' body' , ' pickups ' , 'electronics' ,'bridge' , 'stop tailpiece' , 'pickguard' , 'toggle' , 'switch']
questions_giraffe = [ 'alive' ]
questions_keyboard = ['things' , 'things of computer', 'connect to computer' , 'mouse' , 'button' ,  'letters' , 'number' , 'left' , 'right' , 'space' , 'office' , 'gaming' , 'usb' , 'home' , 'end' , 'lnsert' , 'delete' , 'page up' , 'page down' ,'control' , 'alt' , 'foldable keyboard' , 'shift' , 'enter' , 'ctrl' , 'backspace' ,'voice' , 'silent' , 'shift' , ' alt' , 'fn' , 'alt' ,  'lighting' , 'the darkness' , 'tab' , 'home' , ' pgup' ,' pgdn' , 'esc' , 'top' , 'down' , 'positive' , 'negative' ,'multiplication' , 'division' , 'big' , ' little' , 'hashtak' , ' dot' , 'beauiful' , 'question mark ' , 'exclamation mark']
>>>>>>> cf8fc5348ccd21540478a70ebb3d690523dab516
# kiarash
